#!/usr/bin/env python3
"""RSS feed helper for cc-deepfeed. Manages RSS 2.0 XML files and dedup state."""
...
def init_feed(name, description, feeds_dir, combined_feed, base_url=None, websub_hub=None):
    ...
    ET.SubElement(channel, "generator").text = "cc-deepfeed"
...
def main():
    parser = argparse.ArgumentParser(description="RSS feed helper for cc-deepfeed")
